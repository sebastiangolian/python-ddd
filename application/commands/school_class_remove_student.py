...
@dataclass
class SchoolClassRemoveStudentCommand:
    school_class_id: str
    student_id: str


class SchoolClassRemoveStudentHandler(CommandHandler, BusinessRule):
    def __init__(
        self,
        command: SchoolClassRemoveStudentCommand,
    ...
    async def handle(self) -> None:
        ...
        school_class.remove_student(self.__command.student_id)
